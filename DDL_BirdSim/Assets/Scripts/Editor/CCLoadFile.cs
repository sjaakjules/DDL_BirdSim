...
public class CCLoadFile : EditorWindow {
   ...
   // static Rect s_listRect = new Rect(0, s_MsgLength+s_topOffset, s_WinWidth, s_MsgLength + s_winHeight);
    ...
    public CCtoVoxelReader readPoints;
    public PointCloudData LoadedData;
    ...
    [MenuItem("Deep Design Lab/CloudCompare Files/Load Voxels")]
    ...
    bool createAsset() {
        try {
            LoadedData = CreatePointCloudData.Create();
            string relPath = AssetDatabase.GetAssetPath(LoadedData);
