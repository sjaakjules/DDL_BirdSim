						...
						for (int j = 0; j < header.Properties.Count; ++j) {
							switch (header.Properties[j]) {
								case DataProperty.X:
									...
									break;
								case DataProperty.Y:
									if (flipYZ) data.Vertices[i].z = reader.ReadSingleLittleEndian();else data.Vertices[i].y = reader.ReadSingleLittleEndian();
									break;
								case DataProperty.Z:
									if (flipYZ) data.Vertices[i].y = reader.ReadSingleLittleEndian(); else data.Vertices[i].z = reader.ReadSingleLittleEndian();
									break;
								...
								case DataProperty.NY:
									if (flipYZ) data.Normals[i].z = reader.ReadSingleLittleEndian(); else data.Normals[i].y = reader.ReadSingleLittleEndian();
									break;
								case DataProperty.NZ:
									if (flipYZ) data.Normals[i].y = reader.ReadSingleLittleEndian(); else data.Normals[i].z = reader.ReadSingleLittleEndian();
									break;
						...
						for (int j = 0; j < header.Properties.Count; ++j) {
							switch (header.Properties[j]) {
								case DataProperty.X:
									...
									break;
								case DataProperty.Y:
									if (flipYZ) data.Vertices[i].z = reader.ReadSingleLittleEndian(); else data.Vertices[i].y = reader.ReadSingleBigEndian();
									break;
								case DataProperty.Z:
									if (flipYZ) data.Vertices[i].y = reader.ReadSingleLittleEndian(); else data.Vertices[i].z = reader.ReadSingleBigEndian();
									break;
								...
								case DataProperty.NX:
									...
									break;
								case DataProperty.NY:
									if (flipYZ) data.Normals[i].z = reader.ReadSingleLittleEndian(); else data.Normals[i].y = reader.ReadSingleBigEndian();
									break;
								case DataProperty.NZ:
									if (flipYZ) data.Normals[i].y = reader.ReadSingleLittleEndian(); else data.Normals[i].z = reader.ReadSingleBigEndian();
									break;
						...
						for (int j = 0; j < header.Properties.Count; ++j) {
							switch (header.Properties[j]) {
								case DataProperty.X:
									...
									break;
								case DataProperty.Y:
									if (flipYZ) data.Vertices[i].z = reader.ReadSingleLittleEndian(); else data.Vertices[i].y = reader.ReadSingleAscii();
									break;
								case DataProperty.Z:
									if (flipYZ) data.Vertices[i].y = reader.ReadSingleLittleEndian(); else data.Vertices[i].z = reader.ReadSingleAscii();
									break;
								...
								case DataProperty.NX:
									...
									break;
								case DataProperty.NY:
									if (flipYZ) data.Normals[i].z = reader.ReadSingleLittleEndian(); else data.Normals[i].y = reader.ReadSingleAscii();
									break;
								case DataProperty.NZ:
									if (flipYZ) data.Normals[i].y = reader.ReadSingleLittleEndian(); else data.Normals[i].z = reader.ReadSingleAscii();
									break;
