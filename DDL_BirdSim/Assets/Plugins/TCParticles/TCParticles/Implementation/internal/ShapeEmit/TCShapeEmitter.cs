...
namespace TC {
	...
	public class TCShapeEmitter : MonoBehaviour, ITracked {
		...
		[NonSerialized] internal Vector3 PrevPos;
		[NonSerialized] internal Vector3 PrevSpeed;
		...
		void OnDrawGizmosSelected() {
			...
			Gizmos.DrawIcon(pos, "TCParticles.png", true);
			Matrix4x4 rotationMatrix = Matrix4x4.TRS(pos, mTrans.rotation, mTrans.localScale);
